 ...
 * @author franc
 */
public class BuscadorLibros extends javax.swing.JInternalFrame {
    ...
    public void updateData() {
        ...
        Dimension d = new Dimension(705, 127*panelesLibros.size());
    ...
    private JLabel generateLabel(final int number, boolean selected) {
        ...
        if(!selected) {
            ...
            lbl = new JLabel("<html><body><span style='font-size:120%'><u>" + number + "</u></span></body></html>");
        }
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(208, 100));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(lblCantResultados)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(pnlControlResultados, javax.swing.GroupLayout.DEFAULT_SIZE, 591, Short.MAX_VALUE)
                .addContainerGap())
        );
